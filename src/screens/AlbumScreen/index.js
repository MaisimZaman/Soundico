...
import { View, Text, FlatList, ImageBackground, StyleSheet, TouchableOpacity, Animated, Switch, Image, Dimensions } from "react-native";
...
<ImageBackground style={[styles.containerStyle, styles.blur]} source={{uri: photoAlbum}}>
        <BlurView
